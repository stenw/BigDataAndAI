...
- Why do activation functions need to be nonlinear? What would happen if all activations were linear?
- Why does minimizing training loss not guarantee good test performance in neural networks?
- Did the NN clearly outperform LASSO and boosting?
- How sensitive was performance to hyperparameters?
- What will happen if the learning rate is too small or too large.
- What is the interpretability cost?
- What kinds of epidemiological datasets would *justify* a neural network?


## 11. Optional extensions (if you have time)
